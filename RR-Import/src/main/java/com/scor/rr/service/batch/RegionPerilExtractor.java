...
public class RegionPerilExtractor implements RegionPerilExtractorInterface {
    ...
    public void beforeJob() {
        ...
        if (task != null && task.getJob().getStartedDate() == null && task.getJob().getStatus().equals(JobStatus.PENDING.getCode())) {
    ...
    public RepeatStatus loadRegionPerilAndCreateRRAnalysisAndRRLossTableHeader() {
        ...
        this.beforeJob();
        StepEntity step = jobManager.createStep(Long.valueOf(taskId), "ExtractRegionPeril", 1);
        try {
