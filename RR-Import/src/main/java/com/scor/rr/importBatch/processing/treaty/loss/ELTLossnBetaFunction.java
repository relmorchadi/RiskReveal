 ...
 */
public class ELTLossnBetaFunction extends RMSELTLoss {

    Double minQuantile;
    Double minLayerAtt;
    ConvertFunction convertFunction;

    public ELTLossnBetaFunction(RMSELTLoss rmsELTLoss) {
        super(rmsELTLoss);
    }

    public ELTLossnBetaFunction(RMSELTLoss rmsELTLoss, Double minQuantile, Double minLayerAtt, ConvertFunction convertFunction) {
        super(rmsELTLoss);
