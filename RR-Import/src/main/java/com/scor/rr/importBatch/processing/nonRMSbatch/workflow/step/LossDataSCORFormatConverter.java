...
import com.scor.rr.importBatch.repository.CurrencyRepository;
import com.scor.rr.importBatch.repository.BaseNonRMSBean;
...
import com.scor.rr.importBatch.domain.FinancialPerspective;
import com.scor.rr.importBatch.domain.ProjectImportAssetLog;
import com.scor.rr.importBatch.domain.Step;
...
import com.scor.rr.importBatch.domain.BinFile;
import com.scor.rr.importBatch.domain.RegionPeril;
import com.scor.rr.importBatch.domain.Project;
import com.scor.rr.importBatch.repository.TTFinancialPerspectiveRepository;
import com.scor.rr.importBatch.repository.ProjectImportAssetLogRepository;
...
import com.scor.rr.importBatch.repository.ProjectRepository;
...
public class LossDataSCORFormatConverter extends BaseNonRMSBean {
    ...
    private List<ScorPLTHeader> makeOriginalPurePLTHeaders(TransformationBundleNonRMS bundle, List<TargetRap> targetRaps, PLTModelingBasis modelingBasis) {
        ...
        for (TargetRap targetRap : targetRaps) {
            ...
            Project project = projectRepository.findByModelingResultDataSourceId(getProjectId());
