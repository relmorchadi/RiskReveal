...
public class MainApplication {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            List<PLTLossData> pltLossDatalin = calculAdjustement.lineaireAdjustement(pltLossData,2,false);
            CSVPLTFileWriter csvpltFileWriter = new CSVPLTFileWriter();
            csvpltFileWriter.write(pltLossDatalin, new File("C:\\Users\\u008208\\Desktop\\Lineaire Adjustment with lmf 2 cap.csv"));
            List<PLTLossData> pltLossDatalincap = calculAdjustement.lineaireAdjustement(pltLossData,250,true);
