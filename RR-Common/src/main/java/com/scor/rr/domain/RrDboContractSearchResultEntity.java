...
@Entity
@Table(name = "RR_dbo_ContractSearchResult", schema = "dbo", catalog = "RiskReveal")
public class RrDboContractSearchResultEntity {
    ...
    public boolean equals(Object o) {
        ...
        RrDboContractSearchResultEntity that = (RrDboContractSearchResultEntity) o;
