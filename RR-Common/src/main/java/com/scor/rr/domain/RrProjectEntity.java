...
public class RrProjectEntity {
    ...
    @Basic
    @Column(name = "cloneSourceProject", length = 255)
    ...
    @Basic
    @Column(name = "clonedFlag", length = 255)
    ...
    @Basic
    @Column(name = "linkFlag", length = 255)
    ...
    @Basic
    @Column(name = "masterFlag", length = 255)
    ...
    @Basic
    @Column(name = "postInuredFlag", length = 255)
    ...
    @Basic
    @Column(name = "publishFlag", length = 255)
    ...
    @Basic
    @Column(name = "receptionDate", length = 255)
