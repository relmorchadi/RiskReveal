...
public interface PLTManagerViewRepositoryold extends JpaRepository<PLTManagerThread, Long> {
    /*@Query("SELECT " +
    ...
    @Query("FROM PLTManagerThread plt WHERE plt.workspaceContextCode = :workspaceContextCode AND plt.uwYear = :uwYear AND plt.deletedOn is not null AND plt.deletedDue is not null AND plt.deletedBy is not null")
    Set<PLTManagerThread> findDeletedPLTs(@Param("workspaceContextCode") String workspaceContextCode,@Param("uwYear") Integer uwYear);

    @Query("FROM PLTManagerThread WHERE workspaceContextCode = :workspaceContextCode AND uwYear = :uwYear AND deletedOn is null AND deletedDue is null AND deletedBy is null")
    Set<PLTManagerThread> findPLTs(@Param("workspaceContextCode") String workspaceContextCode,@Param("uwYear") Integer uwYear);
