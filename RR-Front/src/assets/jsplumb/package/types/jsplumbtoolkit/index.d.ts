...
declare module jsPlumbToolkit {
    ...
    class Selection extends AbstractSelectionHolder {
        ...
        eachNode(fn: (obj:Node) => void):void;
        eachGroup(fn: (obj:Group) => void):void;
        eachNodeOrGroup(fn:(obj:NodeOrGroup)=>void):void;
        eachEdge(fn:(obj:Edge)=>void):void;
...
// --------- Rendering types/classes -------------------------
    ...
    type EventOptions<T> = Map<T, Function>;
    type ViewEventOptions = EventOptions<BindableEvent>;
    type SurfaceEventOptions = EventOptions<SurfaceBindableEvent>;
    ...
    class Surface {
        ...
        tracePath(options:PathTracingOptions):boolean;
         ...
         */
        setPosition(node:string|Node|Element, x:number, y:number, doNotUpdateElement?:boolean):ObjectInfo;
    ...
    interface jsPlumbToolkitDropManagerParams {
        targetFilter?:(draggedObject:any, target:Node|Group) => boolean;
        onDrop?:(draggedObject:any, id:string, type:string) => void;
        source:Element;
        selector:string;
        surface:Surface;
    ...
    class jsPlumbToolkitDropManager {
        constructor(params:jsPlumbToolkitDropManagerParams);
        refresh():void;
    }
