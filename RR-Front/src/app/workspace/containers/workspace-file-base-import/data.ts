...
const PltDataTables = [
  ...
  {field: 'TargetCurrency', header: 'Target Currency', width: '80px', type: 'text', sorted: false, filtered: true, highlight: true, visible: true, edit: false},//edit
  ...
  {field: 'File_Path', header: 'File Path', width: '80px', type: 'text', sorted: false, filtered: true, highlight: false, visible: true, edit: false},
  ...
  {field: 'CreateDate', header: ' Created Date', width: '70px', type: 'text', sorted: false, filtered: true, highlight: false, visible: true, edit: false},
    {field: 'File_Last_Update_Date', header: ' Updated Date', width: '70px', type: 'text', sorted: false, filtered: true, highlight: false, visible: true, edit: false},
