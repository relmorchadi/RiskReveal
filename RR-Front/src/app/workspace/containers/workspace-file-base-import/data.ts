...
const PltDataTables = [
  ...
  {field: 'User', header: 'File Path', width: '80px', type: 'text', sorted: false, filtered: true, highlight: false, visible: true},
  {field: 'modelSystemInfo', header: 'Model System Information', width: '200px', type: 'info', sorted: false, filtered: true, highlight: false, visible: true},
  {field: 'ResultsName', header: 'Result Name', width: '170px', type: 'text', sorted: false, filtered: true, highlight: false, visible: true},
  {field: 'ResultsDatabaseName', header: 'Result Database Name', width: '120px', type: 'text', sorted: false, filtered: true, highlight: false, visible: true},
  {field: 'SourceResultsReference', header: 'Source Reference', width: '100px', type: 'text', sorted: false, filtered: true, highlight: false, visible: true},
  {field: 'Currency', header: 'Currency', width: '80px', type: 'text', sorted: false, filtered: true, highlight: false, visible: true},
  {field: 'FinPerspective', header: 'FP', width: '50px', type: 'text', sorted: false, filtered: true, highlight: false, visible: true},
  {field: 'Peril', header: 'Peril', width: '60px', type: 'perilIndicator', sorted: false, filtered: true, highlight: false, visible: true},
  {field: 'Region', header: 'Region', width: '80px', type: 'text', sorted: false, filtered: true, highlight: false, visible: true},
  {field: 'OEP100', header: 'OEP 100', width: '80px', type: 'text', sorted: false, filtered: true, highlight: false, visible: true},
  {field: 'OEP250', header: 'OEP 250', width: '80px', type: 'text', sorted: false, filtered: true, highlight: false, visible: true},
  {field: 'AAL', header: 'AAL', width: '80px', type: 'text', sorted: false, filtered: true, highlight: false, visible: true},
  {field: 'fileDate', header: 'File Date', width: '70px', type: 'text', sorted: false, filtered: true, highlight: false, visible: true},
  {field: 'Run_Date', header: 'Run Date', width: '70px', type: 'text', sorted: false, filtered: true, highlight: false, visible: true},
