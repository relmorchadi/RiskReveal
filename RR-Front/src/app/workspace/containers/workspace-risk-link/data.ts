...
const scrollableColsResults = [
  ...
  {field: 'unitMultiplier', header: 'Unit Multiplier', width: '80px', type: 'number', sorting: '', filtered: true, highlight: true, visible: true, edit: true},
...
const colsFinancialAnalysis = [
  {field: 'selected', header: '', width: '25px', type: 'select', sorting: '', filtered: false, highlight: false, visible: true},
  {field: 'id', header: 'ID', width: '50px', type: 'text', sorting: '', filtered: true, highlight: false, visible: true},
  {field: 'nameDesc', header: 'Name & Description', width: '300px', type: 'branched', sorting: '', filtered: true, highlight: false, visible: true},
  {field: 'regionPeril', header: 'Region Peril', width: '100px', type: 'text', sorting: '', filtered: true, highlight: false, visible: true},
  {field: 'ty', header: 'TY', width: '70px', type: 'iconIndicator', sorting: '', filtered: true, highlight: false, visible: true},
  ...
  {field: 'manager', header: '', width: '25px', type: 'icon', sorting: '', filtered: false, highlight: false, visible: true},
];
