...
import {WorkspaceFileBaseImportComponent} from './workspace-file-base-import/workspace-file-base-import.component';
...
export * from './workspace-accumulation/workspace-accumulation.component';
export * from './workspace-activity/workspace-activity.component';
export * from './workspace-clone-data/workspace-clone-data.component';
export * from './workspace-file-base-import/workspace-file-base-import.component';
