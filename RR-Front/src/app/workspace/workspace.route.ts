...
import {
  ...
  WorkspaceFileBaseImportComponent, WorkspaceInuringComponent, WorkspaceJobManagerComponent,
...
export const workspaceRoutes: Routes = [
  {
    ...
    children: [
      ...
      {data: {title: 'RR- Job Manager'}, path: ':wsId/:year/JobManager', component: WorkspaceJobManagerComponent},
