...
@Component({
  selector: 'node-creation-popup',
  templateUrl: './node-creation-popup.component.html',
  styleUrls: ['./node-creation-popup.component.scss']
})
export class NodeCreationPopupComponent extends BaseComponent implements OnInit {
