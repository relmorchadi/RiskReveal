...
/*ALTER TABLE [dbo].[TaskParams]  WITH CHECK ADD  CONSTRAINT [FKEntity_TaskParams] FOREIGN KEY([Entity])
REFERENCES [dbo].[ENTITY] ([EntityId])
GO

ALTER TABLE [dbo].[TaskParams] CHECK CONSTRAINT [FKEntity_TaskParams]
GO*/
